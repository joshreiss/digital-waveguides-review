function getControlsValues() {
    ...
    var stringDampingVariationSlider = document.getElementById("stringDampingVariation");
    var stringDampingVariation = stringDampingVariationSlider.valueAsNumber;
    var pluckDampingSlider = document.getElementById("pluckDamping");
    var pluckDamping = pluckDampingSlider.valueAsNumber;
    var pluckDampingVariationSlider = document.getElementById("pluckDampingVariation");
    var pluckDampingVariation = pluckDampingVariationSlider.valueAsNumber;
    var stereoSpreadSlider = document.getElementById("stereoSpread");
