...
function Guitar(audioCtx, audioDestination) {
    ...
    this.strings = [ // arguments are audio context, string number, octave, semitone
...
Guitar.C_MAJOR = [-1,  3, 2, 0, 0, 0], Guitar.G_MAJOR = [ 3,  2, 0, 0, 0, 3];
Guitar.A_MINOR = [ 0,  0, 2, 2, 0, 0], Guitar.E_MINOR = [ 0,  2, 2, 0, 3, 0];
