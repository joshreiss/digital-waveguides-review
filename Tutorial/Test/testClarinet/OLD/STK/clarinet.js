...
class Clarinet {
    constructor(audioContext) {
      ...
      this.noiseSource = new AudioBufferSourceNode(this.context,{loop:true})
    ...
    createNoiseBuffer() {
      ...
      this.noiseSource.buffer = this.context.createBuffer(1,bufferSize,this.sampleRate)
      for (let i=0;i<this.context.sampleRate;i++) this.noiseSource.buffer.getChannelData(0)[i] = 2*Math.random()-1
    }    
